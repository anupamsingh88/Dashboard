...
window.ATT = PROJECT_DATA['April'].ATT;
window.PROD = PROJECT_DATA['April'].PROD;
window.GAMS = PROJECT_DATA['April'].GAMS;
window.DAILY_PRESENT = PROJECT_DATA['April'].DAILY_PRESENT;
window.LEADERBOARD = PROJECT_DATA['April'].LEADERBOARD;
window.QUEUE = PROJECT_DATA['April'].QUEUE;
window.ASSESSMENTS = PROJECT_DATA['April'].ASSESSMENTS;
